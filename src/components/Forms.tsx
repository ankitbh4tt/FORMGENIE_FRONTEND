        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-8 gap-4">
          <div className="flex-1">
            ...
            <p className="text-slate-600 text-lg">
              Manage and view all your AI-powered forms
            </p>
          </div>
                ...
                <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-4 gap-3">
                  ...
                  <div className="flex gap-2 flex-shrink-0 self-end lg:self-auto">
                    ...
                    <button
                      ...
                      className="p-2 border-0 rounded-lg cursor-pointer transition-all duration-200 flex items-center justify-center bg-green-50 text-green-600 hover:bg-green-100"
